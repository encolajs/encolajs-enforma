...
import { FormKitConfig } from './useConfig'
...
export function useFormConfig() {
  ...
  const formConfig = inject<FormKitConfig>(formConfigKey, DEFAULT_CONFIG)
   ...
   */
  const getConfig = <T = any>(path: string, defaultValue: T): T => {
