...
import { useDynamicProps } from '../../src/composables/useDynamicProps'
import { ref } from 'vue'
import { formConfigKey, formContextKey, formStateKey } from '../../src/constants/symbols'
import { FormController } from '../../src/types'
import { evaluateCondition, evaluateObject } from '../../src/utils/exprEvaluator'
...
describe('useDynamicProps', () => {
  ...
  test('should handle errors in expression evaluation', () => {
    ...
    expect(consoleErrorSpy).toHaveBeenCalledWith('Error evaluating expression: {$forms.invalid.property}', expect.any(Error))
